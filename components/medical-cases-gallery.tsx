...
export default function MedicalCasesGallery() {
  ...
  return (
    <section className="py-16 lg:py-24" style={{ backgroundColor: "var(--medical-light)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {medicalCases.map((medicalCase, index) => (
            ...
            >
              <div
                className="rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 h-full flex flex-col"
              ...
              >
                ...
                <div className="p-4 flex-1 flex flex-col">
                  <h3
                    className="font-semibold mb-2 min-h-[3rem] flex items-start"
                    style={{ color: "var(--medical-primary)" }}
                  >
                    <span className="line-clamp-2">{medicalCase.title}</span>
                  </h3>
                  <p className="text-sm line-clamp-2 mb-3 flex-1" style={{ color: "var(--medical-secondary)" }}>
                    {medicalCase.description}
                  </p>
                  <div className="flex items-center justify-between mt-auto">
                    <span className="text-xs font-medium" style={{ color: "var(--medical-secondary)" }}>
                      {medicalCase.results}
                    </span>
            ...
            >
              <div className="relative">
                ...
                <div className="p-8">
                  ...
                  <p className="text-lg mb-6 leading-relaxed" style={{ color: "var(--medical-secondary)" }}>
                  ...
                  <div className="p-4 rounded-lg" style={{ backgroundColor: "var(--medical-neutral)" }}>
                    ...
                    <p style={{ color: "var(--medical-secondary)" }}>{selectedCase.results}</p>
                  </div>
                </div>
              </div>
            </motion.div>
